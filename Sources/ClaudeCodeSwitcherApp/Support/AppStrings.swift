...
enum AppStrings {
    ...
    private static let english: [String: String] = [
        ...
        "本地运行，无需云端 API": "Runs locally, no cloud API",
        ...
        "本机 Ollama 模型，使用 Anthropic API 兼容模式。": "Local Ollama model using the Anthropic-compatible API.",
        ...
        "本地 Ollama 无需 API Key": "Local Ollama does not need an API key",
        "使用 Ollama 官方 Anthropic 兼容接口；请保持 Ollama 正在运行。": "Uses Ollama's official Anthropic-compatible API. Keep Ollama running.",
        "刷新": "Refresh",
        "保存密钥": "Save Key",
        "检查版本": "Check Version",
        "更新中": "Updating",
